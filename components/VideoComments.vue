<template>
    <div class="bg-black p-6 rounded-md text-gray-200 border border-gray-600">
        ...
        <div v-for="comment in comments" :key="comment.id" class="mb-4">
          <div class="flex items-start mb-2">
            ...
            <div>
              ...
              <p class="text-sm text-gray-400">{{ comment.snippet.topLevelComment.snippet.textDisplay }}</p>
            </div>
          </div>
        </div>
      </div>
